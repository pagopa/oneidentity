...
variable "ecs_oneid_core" {
  ...
  default = {
    image_version    = "628d3c20b740a873dc1368404665a5365f8d9e54"
    cpu              = 512
    memory           = 1024
    container_cpu    = 512
...
variable "lambda_alarms" {
  ...
  default = {
   "lambda-assertion-error" = {
     lambda_function_name = "oneid-es-1-d-assertion"
     metric_name          = "Errors"
    ...
    "lambda-metadata-error" = {
     lambda_function_name = "oneid-es-1-d-metadata"
     metric_name          = "Errors"
     namespace            = "AWS/Lambda"
     threshold            = 1
     evaluation_periods   = 1
    ...
    "lambda-client-error" = {
     lambda_function_name = "oneid-es-1-d-client-registration"
     metric_name          = "Errors"
     namespace            = "AWS/Lambda"
     threshold            = 1
     evaluation_periods   = 1
