...
| <a name="input_metric_stream_metric_names"></a> [metric\_stream\_metric\_names](#input\_metric\_stream\_metric\_names) | Custom metric names included in the stream. | `list(string)` | <pre>[<br/>  "ClientSuccess",<br/>  "ClientError",<br/>  "ClientCacheMiss",<br/>  "ClientCacheBackfillSuccess",<br/>  "ClientCacheBackfillFailure",<br/>  "IDPSuccess",<br/>  "IDPError"<br/>]</pre> | no |
