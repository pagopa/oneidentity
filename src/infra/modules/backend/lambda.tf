...
data "aws_iam_policy_document" "idp_metadata_lambda" {
  ...
  dynamic "statement" {
    for_each = var.dynamodb_table_idpMetadata.stream_arn == null ? [] : [1]
...
module "idp_metadata_lambda" {
  ...
  allowed_triggers = merge({
    ...
    }, var.dynamodb_table_idpMetadata.stream_arn == null ? {} : {
    dynamodb = {
      principal  = "dynamodb.amazonaws.com"
...
resource "aws_lambda_event_source_mapping" "idp_metadata_stream" {
  count = var.dynamodb_table_idpMetadata.stream_arn == null ? 0 : 1
