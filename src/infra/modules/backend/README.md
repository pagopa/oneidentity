...
| <a name="input_kms_sqs_queue_alias_arn"></a> [kms\_sqs\_queue\_alias\_arn](#input\_kms\_sqs\_queue\_alias\_arn) | Kms key used to encrypt and decrypt sqs queue messages. | `string` | n/a | yes |
