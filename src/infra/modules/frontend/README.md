...
| <a name="module_alb_spid_validator"></a> [alb\_spid\_validator](#module\_alb\_spid\_validator) | terraform-aws-modules/alb/aws | 9.8.0 |
...
|------|-------------|------|---------|:--------:|
| <a name="input_alb_spid_validator_name"></a> [alb\_spid\_validator\_name](#input\_alb\_spid\_validator\_name) | Public application load balancer name for spid validator. | `string` | n/a | yes |
...
| <a name="input_create_alb_spid_validator"></a> [create\_alb\_spid\_validator](#input\_create\_alb\_spid\_validator) | Create the ALB spid to expose the spid validator. | `bool` | `false` | no |
| <a name="input_rest_api_stage"></a> [rest\_api\_stage](#input\_rest\_api\_stage) | Rest api stage name | `string` | `"v1"` | no |
| <a name="input_vpc_cidr_block"></a> [vpc\_cidr\_block](#input\_vpc\_cidr\_block) | VPC Cidr block. Is required when you create the application load balancer. | `string` | `null` | no |
...
| <a name="output_spid_validator_alb_arn"></a> [spid\_validator\_alb\_arn](#output\_spid\_validator\_alb\_arn) | n/a |
| <a name="output_spid_validator_alb_dns_name"></a> [spid\_validator\_alb\_dns\_name](#output\_spid\_validator\_alb\_dns\_name) | n/a |
| <a name="output_spid_validator_alb_security_group_id"></a> [spid\_validator\_alb\_security\_group\_id](#output\_spid\_validator\_alb\_security\_group\_id) | n/a |
| <a name="output_spid_validator_alb_target_group_arn"></a> [spid\_validator\_alb\_target\_group\_arn](#output\_spid\_validator\_alb\_target\_group\_arn) | n/a |
