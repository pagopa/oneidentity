...
public enum ErrorCode {
  ...
  EIDAS_PROTECTED_CLIENT_AUTHORIZATION_ERROR("EIDAS_PROTECTED_CLIENT_AUTHORIZATION_ERROR",
            "eIDAS client cannot be used for authorization"),
  ERRORCODE_NR08(FeErrorCode.ERRORCODE_NR08.getFeErrorCode(), "AUTHNREQUEST_FORMAT_NOT_VALID"),
  ERRORCODE_NR09(FeErrorCode.ERRORCODE_NR09.getFeErrorCode(), "VERSION_MISMATCH"),
  ERRORCODE_NR11(FeErrorCode.ERRORCODE_NR11.getFeErrorCode(), "ID_NOT_VALID"),
  ERRORCODE_NR12(FeErrorCode.ERRORCODE_NR12.getFeErrorCode(), "REQUESTAUTHNCONTEXT_NOT_VALID"),
  ERRORCODE_NR13(FeErrorCode.ERRORCODE_NR13.getFeErrorCode(), "ISSUEINSTANT_NOT_VALID"),
  ERRORCODE_NR14(FeErrorCode.ERRORCODE_NR14.getFeErrorCode(), "DESTINATION_NOT_VALID"),
  ERRORCODE_NR15(FeErrorCode.ERRORCODE_NR15.getFeErrorCode(), "ISPASSIVE_ATTRIBUTE_TRUE"),
  ERRORCODE_NR16(FeErrorCode.ERRORCODE_NR16.getFeErrorCode(), "ACS_INDEX_NOT_VALID"),
  ERRORCODE_NR17(FeErrorCode.ERRORCODE_NR17.getFeErrorCode(), "NAMEIDPOLICY_FORMAT_NOT_VALID"),
  ERRORCODE_NR18(FeErrorCode.ERRORCODE_NR18.getFeErrorCode(),
      "ATTRIBUTE_CONSUMER_SERVICE_IDX_NOT_VALID"),
  ERRORCODE_NR19(FeErrorCode.ERRORCODE_NR19.getFeErrorCode(), "TOO_MANY_SUBMISSIONS"),
  ERRORCODE_NR20(FeErrorCode.ERRORCODE_NR20.getFeErrorCode(), "CREDENTIAL_LEVEL_NOT_VALID"),
  ERRORCODE_NR21(FeErrorCode.ERRORCODE_NR21.getFeErrorCode(), "AUTHENTICATION_TIMEOUT"),
  ERRORCODE_NR22(FeErrorCode.ERRORCODE_NR22.getFeErrorCode(), "CONSENT_DENIED_BY_USER"),
  ERRORCODE_NR23(FeErrorCode.ERRORCODE_NR23.getFeErrorCode(), "SUSPENDED_OR_REVOKED_CREDENTIAL"),
  ERRORCODE_NR25(FeErrorCode.ERRORCODE_NR25.getFeErrorCode(), "AUTHENTICATION_CANCELED_BY_USER"),
  ERRORCODE_NR30(FeErrorCode.ERRORCODE_NR30.getFeErrorCode(),
      "DIGITAL_IDENTITY_TYPE_NOT_CORRESPONDING_TO_REQUIREMENTS"),
  ...
  IDP_ERROR_MULTIPLE_SAMLRESPONSE_SIGNATURES_PRESENT(
      FeErrorCode.FE_IDP_ERROR.getFeErrorCode(),
      "Multiple signatures present in SAMLResponse"),
